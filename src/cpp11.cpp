...
extern "C" SEXP _textshaper_get_string_shape_c(SEXP string, SEXP id, SEXP path, SEXP index, SEXP size, SEXP res, SEXP lineheight, SEXP align, SEXP hjust, SEXP vjust, SEXP width, SEXP tracking, SEXP indent, SEXP hanging, SEXP space_before, SEXP space_after) {
  BEGIN_CPP11
...
extern "C" SEXP _textshaper_get_line_width_c(SEXP string, SEXP path, SEXP index, SEXP size, SEXP res, SEXP include_bearing) {
  BEGIN_CPP11
...
extern "C" {
/* .Call calls */
extern SEXP _textshaper_get_line_width_c(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _textshaper_get_string_shape_c(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);

static const R_CallMethodDef CallEntries[] = {
    {"_textshaper_get_line_width_c",   (DL_FUNC) &_textshaper_get_line_width_c,    6},
    {"_textshaper_get_string_shape_c", (DL_FUNC) &_textshaper_get_string_shape_c, 16},
    {NULL, NULL, 0}
};
}
