...
extern "C" SEXP _textshaping2_get_face_features_c(SEXP path, SEXP index) {
  BEGIN_CPP11
...
extern "C" SEXP _textshaping2_get_string_shape_c(SEXP string, SEXP id, SEXP path, SEXP index, SEXP features, SEXP size, SEXP res, SEXP lineheight, SEXP align, SEXP hjust, SEXP vjust, SEXP width, SEXP tracking, SEXP indent, SEXP hanging, SEXP space_before, SEXP space_after, SEXP direction, SEXP soft_wrap, SEXP hard_wrap) {
  BEGIN_CPP11
...
extern "C" SEXP _textshaping2_get_line_width_c(SEXP string, SEXP path, SEXP index, SEXP size, SEXP res, SEXP include_bearing, SEXP features) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_textshaping2_get_face_features_c", (DL_FUNC) &_textshaping2_get_face_features_c,  2},
    {"_textshaping2_get_line_width_c",    (DL_FUNC) &_textshaping2_get_line_width_c,     7},
    {"_textshaping2_get_string_shape_c",  (DL_FUNC) &_textshaping2_get_string_shape_c,  20},
    {NULL, NULL, 0}
};
}
...
extern "C" attribute_visible void R_init_textshaping2(DllInfo* dll){
